...
const DoctorHeader = () => {
  ...
  const { setViewMode, startInterview } = useInterview();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-xs sm:text-sm font-semibold text-white bg-teal-700 hover:bg-teal-800 px-3 sm:px-3.5 py-2 rounded-xl transition-all shadow-xs cursor-pointer flex items-center gap-1.5"
            title="Start Patient Intake Session"
          >
